...
function bulletmovement() {
    ...
    if (bulletpos < 0 || bulletpos >= 64 ||nextSquare.querySelector('.cannon') ||nextSquare.querySelector(`.titan.${firingPlayer}`)||(bulletpos % 8 == 0 && direction === 'right')||((bulletpos-7) % 8 == 0 && direction === 'left'))
        {
            bullet.remove();
            return;
        }
